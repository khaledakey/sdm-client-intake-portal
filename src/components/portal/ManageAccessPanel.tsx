      ...
      >
        <div className="card-pad">
          ...
          <p style={{ marginTop: 14 }}>
            ...
            feature &mdash; not by sharing a password here or anywhere else.
          </p>
          ...
          <div className="alert" style={{ background: 'var(--surface-tint)', borderColor: 'var(--border-card)', color: 'var(--text-body-strong)', marginTop: 14 }}>
            <span>
              ...
              (whichever role fits) on the platforms SDM needs &mdash; for example your CMS, website
              host, domain registrar, or ad accounts.
            </span>
          </div>

          <p style={{ marginTop: 14, fontSize: 13, color: 'var(--text-muted)' }}>
            Once you&rsquo;ve sent the invite, the SDM team will confirm access on their end &mdash;
